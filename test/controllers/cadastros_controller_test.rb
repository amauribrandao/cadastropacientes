...
class CadastrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cadastro" do
    assert_difference('Cadastro.count') do
      post cadastros_url, params: { cadastro: { carteria: @cadastro.carteria, cpf: @cadastro.cpf, email: @cadastro.email, endereco: @cadastro.endereco, nome: @cadastro.nome, telefone: @cadastro.telefone } }
    end
  ...
  test "should update cadastro" do
    patch cadastro_url(@cadastro), params: { cadastro: { carteria: @cadastro.carteria, cpf: @cadastro.cpf, email: @cadastro.email, endereco: @cadastro.endereco, nome: @cadastro.nome, telefone: @cadastro.telefone } }
